...
namespace TestyDroid.Tests
{
    ...
    public class MicrosoftAndroidEmulatorTests
    {
        ...
        public void Can_Create_Android_Emulator()
        {
            ...
            var emuFactory = new MicrosoftAndroidEmulatorFactory(logger, TestConfig.PathToMicrosoftAndroidEmulatorExe, adbFactory, TestConfig.AvdName, consolePort, true, false, emuId);
        ...
        public async Task Can_Start_And_Stop_Android_Emulator_With_No_Window()
        {
            ...
            var adbFactory = new AndroidDebugBridgeFactory(TestConfig.PathToAdbExe);
            int consolePort = 5554;
            var emuFactory = new MicrosoftAndroidEmulatorFactory(logger, TestConfig.PathToMicrosoftAndroidEmulatorExe, adbFactory, TestConfig.AvdName, consolePort, true, true, emuId);
      ...
      //  [ExpectedException(typeof(InvalidOperationException))]
        public async Task Cannot_Start_Emulator_If_Existing_Device_Using_Port_And_Single_Instance_Mode_Abort_Specified()
        {
            ...
            var adbFactory = new AndroidDebugBridgeFactory(TestConfig.PathToAdbExe);
            int consolePort = 5554;
            var emuFactory = new MicrosoftAndroidEmulatorFactory(logger, TestConfig.PathToAndroidEmulatorExe, adbFactory, TestConfig.AvdName, consolePort, true, true, emuId, SingleInstanceMode.Abort);
        ...
        public async Task Can_Start_Emulator_If_Existing_Device_Using_Port_Then_It_Is_Killed_When_Single_Instance_Mode_KillExisting_Specified()
        {
            ...
            var adbFactory = new AndroidDebugBridgeFactory(TestConfig.PathToAdbExe);
            int consolePort = 5554;
            var emuFactory = new MicrosoftAndroidEmulatorFactory(logger, TestConfig.PathToAndroidEmulatorExe, adbFactory, TestConfig.AvdName, consolePort, true, true, emuId, SingleInstanceMode.KillExisting);
        ...
        public async Task Can_Start_Emulator_If_Existing_Device_Using_Port_Then_It_Is_Reused_When_Single_Instance_Mode_ReuseExisting_Specified()
        {
            ...
            var adbFactory = new AndroidDebugBridgeFactory(TestConfig.PathToAdbExe);
            int consolePort = 5554;
            var emuFactory = new MicrosoftAndroidEmulatorFactory(logger, TestConfig.PathToAndroidEmulatorExe, adbFactory, TestConfig.AvdName, consolePort, true, true, emuId, SingleInstanceMode.ReuseExisting);
            ...
            await droidEmulator.Start(TestConfig.EmulatorStartupTimeout).ContinueWith((t) =>
            {
                ...
                var secondEmuFactory = new MicrosoftAndroidEmulatorFactory(logger, TestConfig.PathToAndroidEmulatorExe, adbFactory, TestConfig.AvdName, consolePort, true, true, secondEmuId, SingleInstanceMode.ReuseExisting);
        ...
        public async Task Can_Start_Emulator_If_Existing_Device_Using_Port_Then_It_Is_Reused_And_Killed_Afterwards_When_Single_Instance_Mode_ReuseExistingThenKill_Specified()
        {
            ...
            var adbFactory = new AndroidDebugBridgeFactory(TestConfig.PathToAdbExe);
            int consolePort = 5554;
            var emuFactory = new MicrosoftAndroidEmulatorFactory(logger, TestConfig.PathToAndroidEmulatorExe, adbFactory, TestConfig.AvdName, consolePort, true, true, emuId, SingleInstanceMode.ReuseExistingThenKill);
            ...
            await droidEmulator.Start(TestConfig.EmulatorStartupTimeout).ContinueWith((Action<System.Threading.Tasks.Task>)((t) =>
            {
                ...
                // now try and start another one on same port.
                Guid secondEmuId = Guid.NewGuid();
                var secondEmuFactory = new MicrosoftAndroidEmulatorFactory(logger, TestConfig.PathToAndroidEmulatorExe, adbFactory, TestConfig.AvdName, consolePort, true, true, secondEmuId, SingleInstanceMode.ReuseExistingThenKill);
